...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (lastInsertedImage && lastInsertedImage.parentNode) {
    const src = lastInsertedImage.src;
    const fileName = src.substring(src.lastIndexOf("/") + 1);
    ...
    // 3. DOM에서 이미지 제거
    lastInsertedImage.parentNode.removeChild(lastInsertedImage);
...
<body>
    <h2>기사쓰기</h2>
    <form name="pWriteFrm" method="post" action="/pWrite.do" onsubmit="return submitPost();">
        <table border="0" width="80%">
            ...
            <tr>
                <td>기사 내용 :</td>
                <td>
                    <div id="editor" contenteditable="true" style="width:90%;min-height:300px;border:1px solid ;padding:10px; overflow-y:visible;"></div>
